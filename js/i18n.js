// Translation dictionary for the EN / FR language toggle.
// Every entry maps a data-i18n key to its English and French text.
window.I18N = {
  ...
  "projects.heading": {
    en: "Ideas taken through to working software.",
  ...
  "contact.body": {
    en: "I'm open to internships, junior roles, and collaborations in software engineering, data, and AI. Feel free to reach out.",
    fr: "Je suis ouverte aux stages, aux postes juniors et aux collaborations en génie logiciel, data et IA. N'hésitez pas à me contacter."
  },

  "footer.built": { en: "Built and deployed with GitHub Pages.", fr: "Conçu et déployé avec GitHub Pages." }
};
